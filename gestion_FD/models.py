...
class These(models.Model):
    ...
    etab_part=models.CharField(max_length=100,default=None,null=True,blank=True)    
...
class Doctorant(models.Model):
    ...
    nom_lab=models.CharField(max_length=20,choices=LABOS) 
    choix=models.ManyToManyField(These,related_name="docts", null=True,blank=True)
    ...
    inscr_valid_cs=models.BooleanField(default=False)
